...
const Order = ({ order }) => {
    ...
    return (
        <div className='container mx-auto py-8 px-4 md:px-16 lg-px-24'>
            ...
            <p className=''>Your order has been placed successfully. You will receive an email confirmation shortly.</p>
            <div className='mt-6 p-4 border rounded-lg bg-gray-100'>
                ...
                <div className='mt-6'>
                    ...
                    <button className='ml-4 bg-red-500 text-white py-2 px-4 hover:bg-red-600' onClick={() => navigate('/')}>Continue Shopping</button>
                </div>
            </div>
        </div>
    );
