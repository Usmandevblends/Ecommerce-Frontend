...
function Footer() {
  return (
    <>
      <footer className='bg-gray-800 py-8 text-white px-4 md:px-16 lg:px-14'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div>
            <h3 className='text-xl font-semibold'>e-Shop</h3>
            <p className='mt-4'>
              Your one-step for all needs. your needs. Shop with use and experience the best online shopping experience.
            </p>
          </div>
          ...
          <div >
            <h4 className='text-lg fonts-semibold'>Fllow us</h4>
